...
<html lang="pt-br">
	<head>
		...
		<link rel="shortcut icon" href="icones/icone.jpg" type="image/x-icon">

		<title>Rodoviária de campinas</title>
			...
			<nav class="navbar navbar-expand-lg navbar-dark cor_barra">
			  	<div class="container-fluid">
					<a class="navbar-brand" href="./">
						<img src="icones/icone.jpg" style="width: 50px; height: 50px;"alt="Imagem de icone">
					</a>
					...
					<div class="collapse navbar-collapse" id="navbarDropdown">
				  		<ul class="navbar-nav">
							...
							<li class="nav-item"><a class="nav-link active" href="pesquisaCEP.php"><?php echo $lng['cep']; ?></a></li>
							<li class="nav-item dropdown">
					  			...
					  			<ul class="dropdown-menu" aria-labelledby="navbarMenuLink">
									<li><a class="dropdown-item" href="usuario.php"><?php echo $lng['cadastrar']; ?></a></li>
					  			</ul>
							...
							<li class="nav-item dropdown">
					  			...
					  			<ul class="dropdown-menu" aria-labelledby="navbarMenuLink">
								    <!-- <li><a class="dropdown-item" href="usuario.php"><?php //echo $lng['cadastro']; ?></a></li> -->
							...
							<li class="nav-item"><a class="nav-link active" href="mostrar.php"><?php echo $lng['mostrar']; ?></a></li>
