<?php include_once("cabec.php"); ?>
	...
	<h2 style="align: center;" class="cor_texto"><?php echo $lng['erroAutentica']; ?></h2>
	...
	<form action="login.php" method="post" class="form card-body row border-dark justify-content-center">
		<div class="col-lg-8 col-sm-12">
			<div class="row g-3 align-items-center">
				<h5 style="align: center;" class="corTextoInverso"><?php echo $lng['loginFalhou']; ?></h5>
			</div>
			
			<p>&nbsp;</p>
			
			<div class="row g-3 align-items-center">
				<h5 style="align: center;" class="corTextoInverso"><?php echo $lng['verifiqueSeusDados']; ?></h5>
			</div>
